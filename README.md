...
## Deploy
The jj repository is colocated with Git. Push bookmark main to origin to run `.github/workflows/deploy.yml`. CI installs locked dependencies, checks, builds, validates output, and deploys the artifact to GitHub Pages. PR builds do not deploy.
