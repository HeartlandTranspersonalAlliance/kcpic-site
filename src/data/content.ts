...
export const agreements = [
  ...
  {
    title: 'Anonymity',
    text: "We don't identify each other as being part of this group when we run into each other in public (e.g. don't go up to someone in their place of work and bring up their integration experience).",
  },
  {
    title: 'Avoid Advice',
    text: "We're not here to ask for or give advice, although you can share what has been helpful for you... (see next agreement)",
  },
  {
    title: '"I" Statements rather than "You" Statements',
    text: 'helps keep us from telling people what they should do. Instead of "you should drink more water" you might say, " when I was in a similar situation, drinking more water helped me."',
  },
  {
    title: 'Step Forward, Step Back',
...
export const resources = [
  {
    ...
    url: 'https://www.psychedelickc.org',
    domain: 'psychedelickc.org',
  },
  {
    name: 'Heartland Transpersonal Alliance',
    url: 'https://heartlandta.org/',
    domain: 'heartlandta.org',
  },
  {
    name: 'Rave Safe KC',
    url: 'https://www.ravesafeinc.com/',
    domain: 'ravesafeinc.com',
  },
  {
    name: 'Elios Connect',
    url: 'https://eleosconnect.com/',
    domain: 'eleosconnect.com',
  },
  {
    name: 'Psychedelic Society of St. Louis',
    url: 'https://psychedelicstl.org/',
    domain: 'psychedelicstl.org',
  },
  {
    name: 'Psychedelic Society of The Ozarks',
    url: 'https://psychedelicsoto.org/',
    domain: 'psychedelicsoto.org',
  },
  {
    name: 'Psychedelic Society of Joplin',
    url: 'https://www.facebook.com/psyclubjoplin/',
    domain: 'facebook.com',
  },
];
