# Content migration — September 17, 2026
...
- All seven resource names and their exact destinations. “Elios Connect” is retained as written on the original site (the destination spells its name Eleos); this is a suggested correction for a future editorial review.
...
- Added navigation/button labels and short supporting interface copy, including homepage eyebrow, circle caption, values strip, footer tagline, and page eyebrows. These are presentation additions, not replacements for original prose.
